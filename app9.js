...
app.get("/janken", (req, res) => {
  ...
  if (num==1 && hand==2) judgement = '負け';
  else if (num==1 && hand==3) judgement = '勝ち';
  else if (num==2 && hand==1) judgement = '勝ち';
  else if (num==2 && hand==3) judgement = '負け';
  else if (num==3 && hand==1) judgement = '負け';
  else if (num==3 && hand==2) judgement = '勝ち';
  else judgement = 'あいこ';
